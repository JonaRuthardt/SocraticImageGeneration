...
def main():
    ...
    p4.add_argument('--device_map',
                    default=device,
                    help='Device to run image generator on.')
    ...
    p5.add_argument('--template', default='config/templates/chatgpt_template_V1.txt', type=str, help='Path to template to use for language model')
    p5.add_argument('--system_prompt', default='config/templates/chatgpt_system_prompt_V1.txt', type=str, help='Path to system prompt to use for language model')
    ...
    p5.add_argument('--best_image_template', default='config/templates/chatgpt_best_image_template.txt', type=str, help='Path to template to use for best image selection')
    p5.add_argument('--system_best_image_prompt', default='config/templates/chatgpt_best_image_system_template.txt', type=str, help='Path to system prompt to use for best image selection')
